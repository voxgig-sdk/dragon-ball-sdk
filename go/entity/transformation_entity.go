...
type TransformationEntity struct {
	name    string
	client  *core.DragonBallSDK
...
func NewTransformationEntity(client *core.DragonBallSDK, entopts map[string]any) *TransformationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransformationEntity) GetName() string { return e.name }
...
func (e *TransformationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TransformationEntity) Deleted() bool {
	return e.deleted
}


func (e *TransformationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTransformationEntity(e.client, opts)
}

func (e *TransformationEntity) Data(args ...any) any {
...
func (e *TransformationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TransformationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TransformationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *TransformationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TransformationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TransformationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TransformationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
