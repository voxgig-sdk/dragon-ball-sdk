...
func TestPlanetEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set DRAGONBALL_TEST_PLANET_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func planetBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("DRAGONBALL_TEST_PLANET_ENTID")
