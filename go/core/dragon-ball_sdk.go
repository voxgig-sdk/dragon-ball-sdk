...
func (sdk *DragonBallSDK) OptionsMap() map[string]any {
...
func (sdk *DragonBallSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DragonBallSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DragonBallSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DragonBallSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DragonBallSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DragonBallSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DragonBallSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DragonBallSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DragonBallSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DragonBallSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
