...
The Ruby SDK for the DragonBall API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `DragonBallError` (a `StandardError` subclass), so wrap
...
```
rb/
├── DragonBall_sdk.rb       -- Main SDK module
