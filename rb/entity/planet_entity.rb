...
class PlanetEntity
  ...
  # @return [Planet, Hash] the loaded Planet; raises DragonBallError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Planet>, Array] the matching Planet items; raises DragonBallError on failure
