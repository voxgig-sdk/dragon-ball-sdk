...
from projectname_sdk import DragonBallSDK
from projectname_sdk.core.spec import DragonBallSpec
from projectname_sdk.core.result import DragonBallResult
from projectname_sdk.core.response import DragonBallResponse
from projectname_sdk.core.operation import DragonBallOperation
from projectname_sdk.core.error import DragonBallError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import DragonBallBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return DragonBallError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DragonBallSDK.test(None, None)
        ...
        class TestInitFeature(DragonBallBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DragonBallBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = DragonBallSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DragonBallSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DragonBallSDK.test(None, setup_opts)
