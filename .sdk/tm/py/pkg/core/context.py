...
from projectname_sdk.core.control import DragonBallControl
...
class DragonBallContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, DragonBallSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DragonBallResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DragonBallResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DragonBallError(code, msg, self)
