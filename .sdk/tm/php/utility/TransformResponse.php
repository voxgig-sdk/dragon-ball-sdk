...
// DragonBall SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class DragonBallTransformResponse
{
    public static function call(DragonBallContext $ctx): mixed
    {
        ...
        $transform = DragonBallHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
