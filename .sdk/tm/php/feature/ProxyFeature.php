...
class DragonBallProxyFeature extends DragonBallBaseFeature
{
    ...
    public function init(DragonBallContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DragonBallContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
