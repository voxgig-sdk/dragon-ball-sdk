...
class DragonBallNetsimFeature extends DragonBallBaseFeature
{
    ...
    private function _simulate(DragonBallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DragonBallContext $ctx, array $applied): void
    {
        $client = $this->client;
