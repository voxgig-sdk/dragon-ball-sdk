...
// DragonBall SDK streaming feature
...
class DragonBallStreamingFeature extends DragonBallBaseFeature
{
    ...
    private function _iterate(DragonBallResult $result): \Generator
    {
    ...
    private function _streamable(DragonBallContext $ctx): bool
    {
