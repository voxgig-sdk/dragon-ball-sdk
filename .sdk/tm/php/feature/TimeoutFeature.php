...
// DragonBall SDK timeout feature
...
class DragonBallTimeoutFeature extends DragonBallBaseFeature
{
    ...
    private function _with_timeout(DragonBallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DragonBallContext $_ctx, float $ms): void
    {
        $client = $this->client;
