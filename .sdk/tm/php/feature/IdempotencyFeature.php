...
// DragonBall SDK idempotency feature
...
class DragonBallIdempotencyFeature extends DragonBallBaseFeature
{
    ...
    private function _mutating(DragonBallContext $ctx): bool
    {
