...
// DragonBall SDK ratelimit feature
...
class DragonBallRatelimitFeature extends DragonBallBaseFeature
{
    ...
    private function _acquire(DragonBallContext $ctx): void
    {
    ...
    private function _track(DragonBallContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
