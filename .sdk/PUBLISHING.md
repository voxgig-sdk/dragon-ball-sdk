...
|---|---|---|
| `ts/` | @voxgig-sdk/dragon-ball-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dragon-ball-sdk \
      --repository voxgig-sdk/dragon-ball-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dragon-ball-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dragon-ball-sdk --id=<id>` removes it.
