...
from dragonball_sdk.utility import register

# Load features
from dragonball_sdk.feature.base_feature import DragonBallBaseFeature
from dragonball_sdk.features import _has_feature, _make_feature
...
class DragonBallSDK:
    ...
    def get_utility(self):
        return DragonBallUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DragonBallSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from dragonball_sdk.entity.character_entity import CharacterEntity
    ...
    def Planet(self, data=None) -> "PlanetEntity":
        ...
        from dragonball_sdk.entity.planet_entity import PlanetEntity
    ...
    def Transformation(self, data=None) -> "TransformationEntity":
        ...
        from dragonball_sdk.entity.transformation_entity import TransformationEntity
