...
class DragonBallTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DragonBallTestRunner.getenv("DRAGONBALL_TEST_LIVE")
        override = DragonBallTestRunner.getenv("DRAGONBALL_TEST_OVERRIDE")
        ...
        explain = DragonBallTestRunner.getenv("DRAGONBALL_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["DRAGONBALL_TEST_EXPLAIN"] = explain
