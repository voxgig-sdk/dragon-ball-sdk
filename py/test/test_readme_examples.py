# DragonBall SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DragonBallSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DragonBallSDK(...) and DragonBallSDK.test(...) become
#      DragonBallSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dragonball_sdk"
_SDK_CLASS = "DragonBallSDK"
