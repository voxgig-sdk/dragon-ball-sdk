...
The TypeScript SDK for the DragonBall API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new DragonBallSDK({ apikey: '...' })
