...
function envOverride(m) {
    if ('TRUE' === process.env.DRAGON_BALL_TEST_LIVE ||
        'TRUE' === process.env.DRAGON_BALL_TEST_OVERRIDE) {
    ...
    m.DRAGON_BALL_TEST_EXPLAIN = process.env.DRAGON_BALL_TEST_EXPLAIN || m.DRAGON_BALL_TEST_EXPLAIN;
    return m;
}
