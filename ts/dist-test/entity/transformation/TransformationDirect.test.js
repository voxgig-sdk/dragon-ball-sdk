...
(0, node_test_1.describe)('TransformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.DragonBallSDK({
    ...
    (0, node_test_1.test)('direct-load-transformation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-transformation', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-transformation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-transformation', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.DRAGON_BALL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.DragonBallSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['DRAGON_BALL_TEST_TRANSFORMATION_ENTID'];
    ...
    const client = new __1.DragonBallSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TransformationDirect.test.js.map