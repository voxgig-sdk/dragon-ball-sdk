...
func registerSDKWords(r *eng.Registry, client *sdk.DragonBallSDK) {
...
func runOp(client *sdk.DragonBallSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
