...
AQL-driven CLI and REPL for the DragonBall SDK. Positional arguments are
...
./dragon-ball-cli load 1 character
./dragon-ball-cli load '{id:1}' character
