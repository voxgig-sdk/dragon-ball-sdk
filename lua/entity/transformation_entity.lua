...
local TransformationEntity = {}
TransformationEntity.__index = TransformationEntity


function TransformationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransformationEntity)
  self._name = "transformation"
  self._client = client
...
function TransformationEntity:get_name()
  return self._name
end


function TransformationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TransformationEntity.new(self._client, opts)
end
...
function TransformationEntity:mark_deleted()
  self._deleted = true
end


function TransformationEntity:deleted()
  return true == self._deleted
end


function TransformationEntity:data_set(args)
  if args ~= nil then
...
function TransformationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransformationEntity:match_set(args)
  if args ~= nil then
...
function TransformationEntity:match_get()
...
function TransformationEntity:stream(action, args, callopts)
...
function TransformationEntity:_run_op(ctx, post_done)
  local utility = self._utility
