...
function runner.env_override(m)
  local live = runner.getenv("DRAGON_BALL_TEST_LIVE")
  local override = runner.getenv("DRAGON_BALL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DRAGON_BALL_TEST_EXPLAIN")
