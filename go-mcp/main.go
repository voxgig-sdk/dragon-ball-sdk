// Command DragonBall-mcp is an MCP server exposing the DragonBall
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DragonBall_list  — list records of an entity
//	DragonBall_load  — load a single record of an entity
//
