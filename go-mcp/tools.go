...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | planet | transformation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DragonBallSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dragon-ball_list",
		Description: "List records from DragonBall. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dragon-ball_load",
		Description: "Load a single record from DragonBall. " +
...
func runOp(client *sdk.DragonBallSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DragonBallSDK, name string) (sdk.DragonBallEntity, error) {
	...
	case "transformation":
		return client.Transformation(nil), nil
