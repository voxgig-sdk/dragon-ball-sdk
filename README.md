...
The Dragon Ball API provides comprehensive information about characters, transformations, power stats, planets, and locations from the Dragon Ball universe.

Learn more about Dragon Ball API at [dragonball-api.com](https://dragonball-api.com).
...
This SDK exposes the API as a small set of **semantic entities** — Character, Planet and Transformation — that you
...
| **Transformation** | The Transformation entity (list, load). | `/transformations` |
