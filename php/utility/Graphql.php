...
// DragonBall SDK utility: graphql
//
...
class DragonBallGraphql
{
    ...
    // equivalent.
    public static function body(DragonBallContext $ctx): mixed
    {
    ...
    public static function errors(DragonBallContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
