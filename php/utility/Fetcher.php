...
// DragonBall SDK utility: fetcher

class DragonBallFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DragonBallSDK/1.0)';
    ...
    public static function call(DragonBallContext $ctx, string $fullurl, array $fetchdef): array
    {
