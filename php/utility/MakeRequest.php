...
// DragonBall SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DragonBallMakeRequest
{
    public static function call(DragonBallContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DragonBallResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DragonBallResponse($fetched);
        } else {
