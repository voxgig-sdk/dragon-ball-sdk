...
// DragonBall SDK telemetry feature
...
class DragonBallTelemetryFeature extends DragonBallBaseFeature
{
    ...
    private function _close(DragonBallContext $ctx, bool $ok): void
    {
