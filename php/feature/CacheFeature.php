...
class DragonBallCacheFeature extends DragonBallBaseFeature
{
    ...
    private function _through(DragonBallContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
