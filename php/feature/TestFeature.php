...
// DragonBall SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class DragonBallTestFeature extends DragonBallBaseFeature
{
    ...
    public function init(DragonBallContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (DragonBallContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = DragonBallParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (DragonBallContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(DragonBallContext $ctx, $op, $args): array
    {
