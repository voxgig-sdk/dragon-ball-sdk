...
class DragonBallRbacFeature extends DragonBallBaseFeature
{
    ...
    private function _required(DragonBallContext $ctx): ?string
    {
    ...
    private function _reject(DragonBallContext $ctx, string $required): void
    {
    ...
    private function _track(DragonBallContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
