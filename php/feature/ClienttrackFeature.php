...
// DragonBall SDK clienttrack feature
...
class DragonBallClienttrackFeature extends DragonBallBaseFeature
{
    ...
    public function PostConstruct(DragonBallContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DragonBall-SDK';
