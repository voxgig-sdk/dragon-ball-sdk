...
// DragonBall SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DragonBallSDK::test)
...
{
    private const SDK_CLASS = 'DragonBallSDK';
    ...
    private const SDK_BASE = 'dragonball_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dragonball_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
