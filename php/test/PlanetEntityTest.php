...
class PlanetEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DRAGON_BALL_TEST_PLANET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function planet_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DRAGON_BALL_TEST_PLANET_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["DRAGON_BALL_TEST_PLANET_ENTID"]);
