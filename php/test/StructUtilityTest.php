...
// DragonBall SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DragonBallOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DragonBallOmni::structfix($now, Struct::undef()))
                        !== json_encode(DragonBallOmni::structfix($val, Struct::undef()))) {
